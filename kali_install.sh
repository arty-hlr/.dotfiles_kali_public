...
then
    ...
    sudo apt -y install py3status fonts-powerline rlwrap ncat mingw-w64 python3-pyftpdlib markdown feh python3-pip python3-venv copyq nemo xclip ranger jq netexec dconf-cli dconf-editor
